...
tellraw @s [{"text":"Nether: ","color":"red"},{"score":{"name":"@s","objective":"xPortal"},"color":"white"}," ",{"score":{"name":"@s","objective":"yPortal"},"color":"white"}," ",{"score":{"name":"@s","objective":"zPortal"},"color":"white"}]
